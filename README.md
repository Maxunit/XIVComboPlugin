...
Please keep in mind, that this fork and plugin are for private use and it might contain changes or bugs, which tend to be fixed with silent patches (means, no version bumps).
