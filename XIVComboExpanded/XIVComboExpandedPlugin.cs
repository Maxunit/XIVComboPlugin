...
public sealed partial class XIVComboExpandedPlugin : IDalamudPlugin
{
    ...
    public XIVComboExpandedPlugin(IDalamudPluginInterface pluginInterface, ISigScanner sigScanner, IGameInteropProvider gameInteropProvider)
    {
