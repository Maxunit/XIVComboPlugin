...
public enum CustomComboPreset
{
    ...
    [SecretCustomCombo]
    [CustomComboInfo("Double Down Feature", "Replace Fated Circle with Double Down when available.", GNB.JobID)]
    ...
    [CustomComboInfo("Overpower Combo", "Replace Overpower with its combo chain (so that you can still use Mythril Tempest by itself in pulls)", WAR.JobID)]
    ...
    WarriorPrimalBeastFeature = 2108,
